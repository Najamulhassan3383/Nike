...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container  p-2 relative"
    >
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((item) => (
            <div key={item.label} className="flex flex-col items-center">
              ...
              <p className="text-xl font-montserrat leading-7 text-slate-gray">
                {item.label}
              </p>
            </div>
          ))}
